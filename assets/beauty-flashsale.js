...
;// CONCATENATED MODULE: ./src/js/sections/beauty-flashsale.js
/* provided dependency */ var beauty_flashsale_createElement = __webpack_require__(6295)["default"];





register('beauty-flashsale', {
  onLoad: function () {
    this.selectors = {
  ...
  initFlashSale: async function (collectionID) {
    ...
    if (res.ok && res.payload) {
      ...
      products.forEach(card => {
        ...
        const component = beauty_flashsale_createElement(SaleProgress, {
