  ...
  constructor() {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(this, "locales", {
      'default': {
        ...
        beauty_discount_noti: `* You are entitled to 1 discount offer of <span>{price}</span> (<span>{discount_title}</span>). This offer <b>can't be combined</b> with any other discount you add here!`,
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(this, "tr", (key, _params = {}) => {
      ...
      let text = ((_locales$shop_locale = locales[shop_locale]) === null || _locales$shop_locale === void 0 ? void 0 : _locales$shop_locale[key]) || locales['default'][key] || `Beauty: translation missing for ${key}!`;
...
function PreOrderNote({
  ...
  return PreOrderNote_createElement("ul", {
    className: 'beauty-preorder-note'
...
;// CONCATENATED MODULE: ./src/js/beauty/helpers.js
...
function handleSubscribe(data) {
  ...
  return new Promise((resolve, reject) => {
    fetch(`${window.Beauty.appURL}/api/public/subscribe?shop=${window.Shopify.shop}`, requestOptions).then(response => response.json()).then(resolve).catch(reject);
  });
}
...
const updateCartAttributes = offer => {
  return new Promise((resolve, reject) => {
    try {
      ...
      let {
        _beautyCartDiscounts
      } = attributes;
      let newAttributes = [];

      if (_beautyCartDiscounts) {
        _beautyCartDiscounts = JSON.parse(_beautyCartDiscounts);

        const found = _beautyCartDiscounts.find(d => JSON.parse(d).product_id === offer.product_id);

        if (found) return;
        newAttributes = [..._beautyCartDiscounts];
      }
      ...
      fetchJSON('/cart/update.js', { ...getRequestDefaultConfigs(),
        ...
        body: JSON.stringify({
          attributes: {
            _beautyCartDiscounts: newAttributes
          }
        })
      }).then(cart => {
...
;// CONCATENATED MODULE: ./src/js/beauty/main.js
...
class Beauty {
  constructor() {
    (0,defineProperty/* default */.Z)(this, "appURL", window.spratlyThemeSettings.beautyAppURL ? `https://${window.spratlyThemeSettings.beautyAppURL}` : '');
    ...
    (0,defineProperty/* default */.Z)(this, "beautyKitSettings", {});

    (0,defineProperty/* default */.Z)(this, "discountCodeKey", 'mn-discount-code');

    (0,defineProperty/* default */.Z)(this, "selectors", {
      bundleContainerOutside: '#beauty-product-bundle-outside',
      bundleContainerInsideDesktop: '.sf-prod-template__desktop #beauty-product-bundle-inside',
      bundleContainerInsideMobile: '.sf-prod-template__mobile #beauty-product-bundle-inside',
    ...
    (0,defineProperty/* default */.Z)(this, "init", async () => {
      ...
      console.log('======> Start init Beauty App plugins!');
      this.domNodes = queryDomNodes(this.selectors);
      await load_assets_loadAssets('beautyApp.css');
      ...
      if (response !== null && response !== void 0 && response.ok && response !== null && response !== void 0 && response.payload) {
        this.beautyKitSettings = { ...response.payload,
          'inCart': {
            active: true
          },
          'prePurchase': {
        ...
        Object.entries(this.beautyKitSettings).forEach(([plugin, data]) => {
    ...
    (0,defineProperty/* default */.Z)(this, "handleCheckout", e => {
      ...
      const newCart = this.generateBeautyCart((_window$spratlyTheme2 = window.spratlyTheme) === null || _window$spratlyTheme2 === void 0 ? void 0 : (_window$spratlyTheme3 = _window$spratlyTheme2.Cart) === null || _window$spratlyTheme3 === void 0 ? void 0 : _window$spratlyTheme3.cart);
      ...
      fetch(`${this.appURL}/api/public/checkout?shop=${this.shop}`, {
        ...
        console.error('Failed to handle checkout by Beauty.', err);
        this.toogleCheckoutEvent(0);
        checkoutButton.click();
      });
    });
    ...
    (0,defineProperty/* default */.Z)(this, "initBis", () => {
      ...
      const {
        bis
      } = this.beautyKitSettings;
      this.BIS = new window.Beauty.BIS(bis);
    });
    ...
    (0,defineProperty/* default */.Z)(this, "initProductRecommendations", () => {
      ...
      const relatedProductSection = document.querySelector('[data-section-type="beauty-related-products"]');
    ...
    (0,defineProperty/* default */.Z)(this, "initPopup", () => {
      ...
      this.Popup = new window.Beauty.Popup(popup);
    });
    ...
    (0,defineProperty/* default */.Z)(this, "initLuckyWheel", () => {
      ...
      this.LuckyWheel = new window.Beauty.LuckyWheel(luckyWheel);
    });
    ...
    (0,defineProperty/* default */.Z)(this, "initSalesNotification", () => {
      ...
      this.SalesPop = new window.Beauty.SalesNotifications(settings);
    });
    ...
    (0,defineProperty/* default */.Z)(this, "initPrePurchase", () => {
      ...
      this.PrePurchase = new window.Beauty.PrePurchase(prePurchase);
    });
    ...
    (0,defineProperty/* default */.Z)(this, "initCartGoal", () => {
      ...
      this.CartGoal = new window.Beauty.CartGoal(cartGoal);
    });

    (0,defineProperty/* default */.Z)(this, "initInCart", () => {
      this.InCart = new window.Beauty.InCart();
    });
    ...
    (0,defineProperty/* default */.Z)(this, "initQuantityDiscount", () => {
      ...
      this.QuantityDiscount = new window.Beauty.QuantityDiscount(quantityDiscount);
    });
    ...
    (0,defineProperty/* default */.Z)(this, "getNewCart", async cart => {
      return new Promise((resolve, reject) => {
        var _this$beautyKitSettings, _this$beautyKitSettings$;

        const beautyCart = this.generateBeautyCart(cart);
        if (!beautyCart) return resolve();
        const apiVersion = ((_this$beautyKitSettings = this.beautyKitSettings) === null || _this$beautyKitSettings === void 0 ? void 0 : (_this$beautyKitSettings$ = _this$beautyKitSettings.shop) === null || _this$beautyKitSettings$ === void 0 ? void 0 : _this$beautyKitSettings$.discount_apply_by) === 'discount_code' ? '/v2' : '';
        const cartAPI = `${this.appURL}/api/public${apiVersion}/cart/?shop=${this.shop}`;
        fetch(cartAPI, {
          method: 'POST',
          body: JSON.stringify(beautyCart)
        }).then(res => res.json()).then(resolve).catch(reject);
      });
    });

    (0,defineProperty/* default */.Z)(this, "generateBeautyCart", cart => {
      var _cart$items, _beautyCartDiscounts2, _window$Shopify, _this$beautyKitSettings2, _this$beautyKitSettings3;
      ...
      if ((_beautyCartDiscounts2 = _beautyCartDiscounts) !== null && _beautyCartDiscounts2 !== void 0 && _beautyCartDiscounts2.length) {
        _beautyCartDiscounts = JSON.parse(_beautyCartDiscounts).map(d => JSON.parse(d));
      }
      ...
      if (cartGoal && this.CartGoal) {
        const {
          active,
          disable_beauty_discount
        } = cartGoal;

        if (active && !disable_beauty_discount && this.CartGoal.goalDone && this.CartGoal.enabled) {
          _beautyCartDiscounts.push({
      ...
      newCart.attributes = { ...attributes,
        _beautyCartDiscounts: [..._beautyCartDiscounts]
      };
      ...
      newCart._beautyCurrency = { ...(((_window$Shopify = window.Shopify) === null || _window$Shopify === void 0 ? void 0 : _window$Shopify.currency) || {}),
        published: (_this$beautyKitSettings2 = this.beautyKitSettings) === null || _this$beautyKitSettings2 === void 0 ? void 0 : (_this$beautyKitSettings3 = _this$beautyKitSettings2.shop) === null || _this$beautyKitSettings3 === void 0 ? void 0 : _this$beautyKitSettings3.currency
      };
      return newCart;
    });
    ...
    (0,defineProperty/* default */.Z)(this, "renderNewCart", cart => {
      ...
      this.getNewCart(cart).then(({
        ...
        let showBeautyWarning = false;

        if (newCart) {
          var _this$beautyKitSettings$2, _this$lastDiscount;

          this.newCart = newCart;

          _ThemeEvent.emit('ON_BEAUTY_CART_UPDATE', newCart);

          const {
            _beautyCartPrices
          } = newCart;
          let shouldAddCheckoutEvent = !!(_beautyCartPrices !== null && _beautyCartPrices !== void 0 && _beautyCartPrices.total_discounted_amount);

          if (((_this$beautyKitSettings$2 = this.beautyKitSettings.shop) === null || _this$beautyKitSettings$2 === void 0 ? void 0 : _this$beautyKitSettings$2.discount_apply_by) !== 'discount_code') {
            const cartGoalSettings = this.beautyKitSettings.cartGoal;
          ...
          this.applyDiscount(_beautyCartPrices === null || _beautyCartPrices === void 0 ? void 0 : _beautyCartPrices.discount);
          (_this$lastDiscount = this.lastDiscount) === null || _this$lastDiscount === void 0 ? void 0 : _this$lastDiscount.remove();

          if (_beautyCartPrices) {
            showBeautyWarning = true;
            const {
              cartDiscounts,
              subTotalPrice,
        ...
        if (this.cartNodes.couponMessages) {
          ...
          if (showBeautyWarning) {
            msg = main_i18n.tr('beauty_discount_noti', {
              price: currency_formatMoney(newCart._beautyCartPrices.total_discounted_amount, spratlyThemeSettings.money_format),
    ...
    (0,defineProperty/* default */.Z)(this, "toogleCheckoutEvent", discounted_amount => {
      var _this$beautyKitSettings4, _this$beautyKitSettings5;

      const {
        checkoutButton
      } = this.cartNodes;
      const useDraftOrder = ((_this$beautyKitSettings4 = this.beautyKitSettings) === null || _this$beautyKitSettings4 === void 0 ? void 0 : (_this$beautyKitSettings5 = _this$beautyKitSettings4.shop) === null || _this$beautyKitSettings5 === void 0 ? void 0 : _this$beautyKitSettings5.discount_apply_by) !== 'discount_code';
    ...
    (0,defineProperty/* default */.Z)(this, "applyDiscount", discount => {
      ...
      if ((codeDiscount === null || codeDiscount === void 0 ? void 0 : codeDiscount.status) === "ACTIVE" && shareable_url) {
        ...
        if (current_code !== code) {
          fetch(shareable_url).then(() => console.log(`[Beauty] - Discount applied. Code: ${code} - ${summary}`)).catch(console.error);
        }
      }
    });
    ...
    if (!appURL) {
      return console.log(`%c[Beauty Kit] App hasn't been installed on this Shop!`, 'background-color:#ffd79d; color: #000; font-size: 14px;');
    }

    if (!shop) {
      return console.log(`%c[Beauty Kit] Couldn't find 'shop' in 'window.Shopify'!`, 'background-color:#ffd79d; color: #000; font-size: 14px;');
    }
...
/* harmony default export */ var main = ((/* unused pure expression or super */ null && (Beauty)));
window.Beauty = new Beauty();
}();
/******/ })()
;