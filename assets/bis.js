...
// EXTERNAL MODULE: ./src/js/beauty/i18n.js
...
const Popup = ({
  ...
  const saveToSubscriptionList = save_to.indexOf('beauty_subscribers') !== -1;
...
;// CONCATENATED MODULE: ./src/js/beauty/plugins/bis.js
