...
function LuckyWheel_LuckyWheel({
  ...
  return LuckyWheel_createElement("div", {
    ...
    className: "lucky-wheel__overlay beauty__overlay"
  }), LuckyWheel_createElement("div", {
...
class LuckyWheel {
  constructor(settings) {
    ...
    (0,defineProperty/* default */.Z)(this, "saveKey", '__beauty_luckywheel');

    (0,defineProperty/* default */.Z)(this, "forceOpenQueryFlag", 'beauty_show_lucky_wheel');

    (0,defineProperty/* default */.Z)(this, "currentCode", void 0);

    (0,defineProperty/* default */.Z)(this, "showTimeOut", null);

    (0,defineProperty/* default */.Z)(this, "appURL", window.Beauty.appURL);
    ...
    (0,defineProperty/* default */.Z)(this, "handleSubmit", async () => {
      ...
      if (validated) {
        ...
        const saveToApp = (_this$settings9 = this.settings) === null || _this$settings9 === void 0 ? void 0 : (_this$settings9$save_ = _this$settings9.save_to) === null || _this$settings9$save_ === void 0 ? void 0 : _this$settings9$save_.includes('beauty_subscribers');
...
window.Beauty.LuckyWheel = LuckyWheel;
}();
/******/ })()
;