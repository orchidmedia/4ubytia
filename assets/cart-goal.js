...
;// CONCATENATED MODULE: ./src/js/beauty/confetti.js
...
class CartGoal {
  constructor(settings) {
    ...
    (0,defineProperty/* default */.Z)(this, "init", () => {
      var _window$spratlyTheme, _window$spratlyTheme$, _window$Beauty, _window$spratlyTheme2, _window$spratlyTheme3;
      ...
      this.updateProgress(((_window$Beauty = window.Beauty) === null || _window$Beauty === void 0 ? void 0 : _window$Beauty.newCart) || ((_window$spratlyTheme2 = window.spratlyTheme) === null || _window$spratlyTheme2 === void 0 ? void 0 : (_window$spratlyTheme3 = _window$spratlyTheme2.Cart) === null || _window$spratlyTheme3 === void 0 ? void 0 : _window$spratlyTheme3.cart));
      this.listenCartChange();
      this.confettiShow = this.goalDone;
    });

    (0,defineProperty/* default */.Z)(this, "updateProgress", cart => {
      var _cart$_beautyCartPrices, _window$spratlyThemeS;

      const cartTotal = ((_cart$_beautyCartPrices = cart._beautyCartPrices) === null || _cart$_beautyCartPrices === void 0 ? void 0 : _cart$_beautyCartPrices.total_price) || (cart === null || cart === void 0 ? void 0 : cart.total_price);
    ...
    (0,defineProperty/* default */.Z)(this, "listenCartChange", () => {
      window._ThemeEvent.subscribe('ON_BEAUTY_CART_UPDATE', async cart => {
        if (cart) {
...
window.Beauty.CartGoal = CartGoal;
}();
/******/ })()
;