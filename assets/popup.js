...
class Popup {
  constructor(settings) {
    ...
    (0,defineProperty/* default */.Z)(this, "saveKey", '__beauty_popup');

    (0,defineProperty/* default */.Z)(this, "forceOpenQueryFlag", 'beauty_show_popup');
    ...
    (0,defineProperty/* default */.Z)(this, "handleSubmit", async () => {
      ...
      if (validated) {
        ...
        const saveToApp = (_this$settings21 = this.settings) === null || _this$settings21 === void 0 ? void 0 : (_this$settings21$save = _this$settings21.save_to) === null || _this$settings21$save === void 0 ? void 0 : _this$settings21$save.includes('beauty_subscribers');
    ...
    this.popup = new modal('beauty-popup');
